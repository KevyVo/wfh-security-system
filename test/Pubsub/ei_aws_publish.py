...
while 1==1:
    ...
    if connflag == True:
        ...
        mqttc.publish("Smart_Lock", paylodmsg_json , qos=1)        # topic: temperature # Publishing Temperature values
        print("msg sent: Smart_Lock" ) # Print sent temperature msg on console
