                ...
                if (f.readImage() == True): #READ if finger is read
                    ...
                    #Fingerprint authentication
                        ...
                        if (count >= 3):
                            ...
                            #E-mail
                            mail.sendItem("example@mail.com", ("This is attempt number on Force Entry Reset: " + str(count)), ("A timeout was trigger at the attempt #" + str(count) + ", a timeout of " + str(timeout*5) + " mins has been set. This was capture at " + dt_string + " and Image stored locally at " + imageDestination), imageDestination)
                            print('The image was saved to "' + imageDestination + "at the time: " + d_string + '".')
            ...
            if (f.readImage() == True): #READ if finger is read
                ...
                if ((positionNumber != -1 and accuracyScore >= 50)): #Finger is in database if true
                    ...
                    if (count >= 3):
                        ...
                        #E-mail
                        mail.sendItem("example@mail.com", ("This is attempt number:" + str(count)), ("A timeout was trigger at the attempt #" + str(count) + ", a timeout of " + str(timeout*5) + " mins has been set. This was capture at " + dt_string + " and Image stored locally at " + imageDestination), imageDestination)
                        print('The image was saved to "' + imageDestination + "at the time: " + d_string + '".')
